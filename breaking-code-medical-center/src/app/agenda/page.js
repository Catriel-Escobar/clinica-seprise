                                                ...
                                                {isCalendarOpen && (
                                                    ...
                                                    >
                                                        <div className="flex items-center justify-between px-1">
                                                            <button
                                                                id="prevMonth"
                                                                className="rounded-md px-2 py-2 text-dark hover:bg-gray-2"
                                                        ...
                                                        <div
                                                            id="days-of-week"
                                                            className="mb-4 mt-6 grid grid-cols-7 gap-2 px-1"
                                                        >
                                ...
                                >
                                    ...
                                    <div className="w-80">
                                        <button
                                            ...
                                            type="button"
                                            className={`m-2 rounded px-4 py-4 text-white ${item.turno ? 'bg-white' : 'bg-[#87b9a5]'}`}
                                        ...
                                        <button
                                            onClick={handleClick}
                                            className="m-2 rounded px-4 py-4 bg-[#87b9a5]"
                                        >
                                            <MdOutlineModeEdit />
                                        </button>
                                        <button
